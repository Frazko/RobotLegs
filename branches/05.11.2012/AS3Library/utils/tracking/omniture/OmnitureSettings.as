package utils.tracking.omniture {
	...
	public class OmnitureSettings {
		...
		private var _debugTracking : Boolean = true;
		private var _trackLocal : Boolean = true;
		
		
		private var _charSet : String = 'UTF-8';
		private var _currencyCode : String = 'GBP';
		
		private var _dc : String = '122';
		private var _vmk : String;
		private var _cookieDomainPeriods : int = 3;
		...
		private var _account : String = "nissaneuukprod";
		private var _visitorNamespace : String = "nissaneurope";
		private var _trackingServer : String = "nissaneurope.d1.sc.omtrdc.net";
		
		/* 
		 * NOT REFERENCED IN THE DOCUMENT SENT THROUGH
		 */
		...
		public function OmnitureSettings(s : AppMeasurement) : void {
			_s = s;
			_s.account = _account;
			_s.dc = _dc;
			_s.vmk = _vmk;
		...
		public function get vmk() : String {
			return _vmk;
		}
		...
		public function get trackingSecureServer() : String {
			return _trackingSecureServer;
		}
		...
		public function get cookieDomainPeriods() : int {
			return _cookieDomainPeriods;
		}
		...
		public function get cookieLifetime() : String {
		...
		public function get linkLeaveQueryString() : Boolean {
			return _linkLeaveQueryString;
		}
		...
		public function get trackDownloadLinks() : Boolean {
			return _trackDownloadLinks;
		}
		...
		public function get trackExternalLinks() : Boolean {
			return _trackExternalLinks;
		}
		...
		public function get delayTracking() : Number {
			return _delayTracking;
		}
